    ...
    <nav className="w-64 border-r border-gray-200 min-h-screen p-4">
        ...
        <ul className="space-y-2">
          <li>
            <button
              ...
              className={`w-full text-left px-3 py-2 rounded-md ${
                isActive(apiName!) ? 'bg-gray-100' : 'hover:bg-gray-50'
              }`}
            >
          ...
          <li>
            <button
              ...
              className={`w-full text-left px-3 py-2 rounded-md ${
                isActive('deployments') ? 'bg-gray-100' : 'hover:bg-gray-50'
              }`}
            >
              <div className="flex items-center">
      ...
      <div>
        ...
        <button
          ...
          className="flex items-center space-x-2 text-sm text-gray-600 hover:text-gray-900 px-3 py-2"
        >
