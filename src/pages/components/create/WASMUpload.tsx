...
const WASMUpload = () => {
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-gray-700 mb-1">WASM Binary</label>
      <p className="text-sm text-gray-600 mb-3">The compiled WASM binary of your component.</p>
      <div 
